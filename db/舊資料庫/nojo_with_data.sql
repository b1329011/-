...
INSERT INTO `address` (`address_id`, `city`, `district`, `street_line`, `formatted`) VALUES
(1, '台北市', '大安區', '和平東路一段100號', '台北市大安區和平東路一段100號'),
(2, '新北市', '板橋區', '文化路一段88號', '新北市板橋區文化路一段88號'),
(3, '台中市', '西屯區', '台灣大道三段200號', '台中市西屯區台灣大道三段200號');
...
INSERT INTO `gamesmatches` (`game_id`, `user_id`, `court_id`, `sport_id`, `least_players`, `most_players`, `split_price`, `target_level`, `weather_index`, `air_index`, `match_status`, `booking_date`, `time_slot`, `total_price`, `deposit_required`, `cancel_deadline`, `is_confirmed`, `booking_status`) VALUES
(1, 1, 1, 1, 6, 10, '100.00', 'casual', '85.50', 40, 'recruiting', '2026-06-01', '18:00-20:00', '1000.00', 1, '2026-05-31 10:00:00', 1, 'booked'),
(2, 2, 2, 2, 2, 4, '150.00', 'advanced', '92.00', 25, 'full', '2026-06-03', '19:00-21:00', '600.00', 0, '2026-06-02 11:00:00', 1, 'booked'),
(3, 1, 3, 3, 8, 12, '80.00', 'beginner', '70.00', 55, 'recruiting', '2026-06-05', '15:00-18:00', '960.00', 0, '2026-06-04 07:00:00', 0, 'pending');
...
INSERT INTO `venues` (`venue_id`, `address_id`, `name`, `base_price`, `opening_hours`, `facilities`, `types`) VALUES
(1, 1, '大安運動中心', '500.00', '{\"open\": \"08:00\", \"close\": \"22:00\"}', '[\"parking\", \"locker\"]', 'indoor'),
(2, 2, '板橋羽球館', '300.00', '{\"open\": \"09:00\", \"close\": \"23:00\"}', '[\"wifi\", \"shower\"]', 'indoor'),
(3, 3, '台中陽光球場', '200.00', '{\"open\": \"07:00\", \"close\": \"21:00\"}', '[\"parking\"]', 'outdoor');
